...
import { type RouteManifest, type DefineRoutesFunction } from "./config/routes";
...
export declare function resolveConfig(appConfig: AppConfig, { rootDirectory, serverMode, isSpaMode, routeConfigChanged, vite, viteUserConfig, routesViteNodeContext, }: {
    rootDirectory: string;
    serverMode?: ServerMode;
    isSpaMode?: boolean;
...
export declare function logFutureFlagWarnings(future: FutureConfig): void;
export {};
