...
async function resolveConfig(appConfig, {
  ...
  if ((_appConfig$future2 = appConfig.future) !== null && _appConfig$future2 !== void 0 && _appConfig$future2.unstable_routeConfig) {
  ...
  let future = {
    ...
    v3_singleFetch: ((_appConfig$future6 = appConfig.future) === null || _appConfig$future6 === void 0 ? void 0 : _appConfig$future6.v3_singleFetch) === true,
    v3_lazyRouteDiscovery: ((_appConfig$future7 = appConfig.future) === null || _appConfig$future7 === void 0 ? void 0 : _appConfig$future7.v3_lazyRouteDiscovery) === true,
    unstable_optimizeDeps: ((_appConfig$future8 = appConfig.future) === null || _appConfig$future8 === void 0 ? void 0 : _appConfig$future8.unstable_optimizeDeps) === true,
    unstable_routeConfig: ((_appConfig$future9 = appConfig.future) === null || _appConfig$future9 === void 0 ? void 0 : _appConfig$future9.unstable_routeConfig) === true
  };
  if (appConfig.future) {
