...
function Ot(a2, t, e) {
  Object.defineProperty(a2, t, { enumerable: !1, configurable: !0, value: e });
}
function ti({ toMessage: a2, code: t, reasonCode: e, syntaxPlugin: s }) {
  ...
  return function r(n, o) {
    ...
    }), Ot(h, "details", o), Object.defineProperty(h, "message", { configurable: !0, get() {
      let l = `${a2(o)} (${n.line}:${n.column})`;
...
function F(a2, t) {
  if (Array.isArray(a2)) return (s) => F(s, a2[0]);
  let e = {};
  for (let s of Object.keys(a2)) {
    let i = a2[s], r = typeof i == "string" ? { message: () => i } : typeof i == "function" ? { message: i } : i, { message: n } = r, o = Ws(r, ei), h = typeof n == "string" ? () => n : n;
...
function ii(a2) {
  let t = si();
  if (a2 == null) return t;
  if (a2.annexB != null && a2.annexB !== !1) throw new Error("The `annexB` option can only be set to `false`.");
...
function ne(a2) {
  return Ft(a2.loc.start, "index"), Ft(a2.loc.end, "index"), a2;
}
function S(a2, t = {}) {
  t.keyword = a2;
  let e = P(a2, t);
  return ft.set(a2, e), e;
}
function v(a2, t) {
  return P(a2, { beforeExpr: T, binop: t });
}
function P(a2, t = {}) {
  return ++pe, mt.push(a2), yt.push(t.binop ?? -1), xt.push(t.beforeExpr ?? !1), Pt.push(t.startsExpr ?? !1), gt.push(t.prefix ?? !1), dt.push(new we(a2, t)), pe;
}
function b(a2, t = {}) {
  return ++pe, ft.set(a2, pe), mt.push(a2), yt.push(t.binop ?? -1), xt.push(t.beforeExpr ?? !1), Pt.push(t.startsExpr ?? !1), gt.push(t.prefix ?? !1), dt.push(new we("name", t)), pe;
}
function w(a2) {
  return a2 >= 93 && a2 <= 133;
}
...
function Ke(a2, t) {
  ...
  for (let s = 0, i = t.length; s < i; s += 2) {
    if (e += t[s], e > a2) return !1;
    if (e += t[s + 1], e >= a2) return !0;
  }
  return !1;
}
function B(a2) {
  return a2 < 65 ? a2 === 36 : a2 <= 90 ? !0 : a2 < 97 ? a2 === 95 : a2 <= 122 ? !0 : a2 <= 65535 ? a2 >= 170 && Pi.test(String.fromCharCode(a2)) : Ke(a2, Yt);
}
function K(a2) {
  return a2 < 48 ? a2 === 36 : a2 < 58 ? !0 : a2 < 65 ? !1 : a2 <= 90 ? !0 : a2 < 97 ? a2 === 95 : a2 <= 122 ? !0 : a2 <= 65535 ? a2 >= 170 && gi.test(String.fromCharCode(a2)) : Ke(a2, Yt) || Ke(a2, Ti);
}
function Qt(a2, t) {
  return t && a2 === "await" || a2 === "enum";
}
function Zt(a2, t) {
  return Qt(a2, t) || Ai.has(a2);
}
function es(a2) {
  return Si.has(a2);
}
function ts(a2, t) {
  return Zt(a2, t) || es(a2);
}
function wi(a2) {
  return bi.has(a2);
}
function Ci(a2, t, e) {
  return a2 === 64 && t === 64 && B(e);
}
function Ii(a2) {
  return Ei.has(a2);
}
...
function Ut(a2, t, e) {
  for (let s = t; s < e; s++) if (G(a2.charCodeAt(s))) return !0;
  return !1;
}
function Fi(a2) {
  switch (a2) {
...
function V(a2) {
  return a2 ? a2.type === "JSXOpeningFragment" || a2.type === "JSXClosingFragment" : !1;
}
function J(a2) {
  if (a2.type === "JSXIdentifier") return a2.name;
  if (a2.type === "JSXNamespacedName") return a2.namespace.name + ":" + a2.name.name;
  if (a2.type === "JSXMemberExpression") return J(a2.object) + "." + J(a2.property);
...
function $(a2, t, e) {
  ...
  s === null || s.start > e.start ? X(a2, e.comments) : ss(s, e.comments);
}
function jt(a2, t, e, s, i, r) {
  ...
  for (; ; ) {
    ...
    } else x === 8232 || x === 8233 ? (++e, ++i, s = e) : x === 10 || x === 13 ? a2 === "template" ? (l += t.slice(f, e) + `
...
`);
    ...
    case 120: {
      let l;
      return { code: l, pos: t } = et(a2, t, e, s, 2, !1, n, r), o(l === null ? null : String.fromCharCode(l));
    }
    case 117: {
      let l;
...
function et(a2, t, e, s, i, r, n, o) {
  let h = t, l;
  return { n: l, pos: t } = is(a2, t, e, s, 16, i, r, !1, o, !n), l === null && (n ? o.invalidEscapeSequence(h, e, s) : t = h - 1), { code: l, pos: t };
}
...
function rs(a2, t, e, s, i, r) {
  ...
  if (n === 123) {
    if (++t, { code: o, pos: t } = et(a2, t, e, s, a2.indexOf("}", t) - t, !0, i, r), ++t, o !== null && o > 1114111) if (i) r.invalidCodePoint(t, e, s);
    else return { code: null, pos: t };
  } else ({ code: o, pos: t } = et(a2, t, e, s, 4, !1, i, r));
  return { code: o, pos: t };
}
function he(a2, t, e) {
...
function lt(a2) {
  if (a2.extra?.parenthesized) return !1;
  switch (a2.type) {
    case "Identifier":
      return !0;
...
function Gi(a2) {
  if (a2.type !== "MemberExpression") return !1;
  let { computed: t, property: e } = a2;
  return t && e.type !== "StringLiteral" && (e.type !== "TemplateLiteral" || e.expressions.length > 0) ? !1 : os(a2.object);
}
function Xi(a2, t) {
  let { type: e } = a2;
  if (a2.extra?.parenthesized) return !1;
...
function os(a2) {
  return a2.type === "Identifier" ? !0 : a2.type !== "MemberExpression" || a2.computed ? !1 : os(a2.object);
}
function er(a2) {
...
function ar(a2) {
  let t = {};
  for (let e of Object.keys(a2)) t[e] = Gt(a2[e]);
  return t;
}
function le(a2, t) {
...
function nr(a2) {
  let t = [];
  for (let i of tr) a2.has(i) && t.push(i);
...
function cr(a2, t) {
  return t === !1 ? !1 : a2.charAt(t) === "/" && a2.charAt(t + 1) === "/" ? ls(a2, t) : t;
}
function lr(a2, t) {
  let e = null, s = t;
  for (; s !== e; ) e = s, s = cs(a2, s), s = ps(a2, s), s = ds(a2, s), s = fs(a2, s);
  return s;
}
function ys(a2) {
  let t = [];
...
function Ar(a2) {
  ...
  for (let e = a2.length - 1; e >= 0; e--) {
    let s = a2[e];
    if (t && L(s) === M(t) && Ct(s) && Ct(t) && (a2.splice(e + 1, 1), s.value += "*//*" + t.value, s.range = [M(s), L(t)]), !gs(s) && !se(s)) throw new TypeError(`Unknown comment type: "${s.type}".`);
    t = s;
  }
}
function Sr(a2) {
...
function ye(a2) {
  ...
  return me = ye.prototype = a2 ?? /* @__PURE__ */ Object.create(null), new ye();
}
function Et(a2) {
  return ye(a2);
}
...
function Le(a2, t) {
  if (!As(a2)) return a2;
  if (Array.isArray(a2)) {
    for (let s = 0; s < a2.length; s++) a2[s] = Le(a2[s], t);
    return a2;
  }
  if (t.onEnter) {
    let s = t.onEnter(a2) ?? a2;
    if (s !== a2) return Le(s, t);
    a2 = s;
  }
  let e = Cs(a2);
  for (let s = 0; s < e.length; s++) a2[e[s]] = Le(a2[e[s]], t);
  ...
  return a2 = Es(a2, { onEnter(h) {
    switch (h.type) {
      case "ParenthesizedExpression": {
        ...
        return f ? void 0 : (l.extra = { ...l.extra, parenthesized: !0 }, l);
      }
      ...
      case "TopicReference":
        a2.extra = { ...a2.extra, __isUsingHackPipeline: !0 };
        break;
      case "TSUnionType":
...
function Ms(a2) {
  ...
  let e = "";
  for (; e !== a2; ) e = a2, a2 = xe(0, a2, Br, `
$1 $2
`);
  a2 = a2.replace(vs, "").trimEnd();
  let s = /* @__PURE__ */ Object.create(null), i = xe(0, a2, Ls, "").replace(vs, "").trimEnd(), r;
  for (; r = Ls.exec(a2); ) {
    let n = xe(0, r[2], Fr, "");
...
function _s(a2) {
  if (typeof a2 == "string") {
    if (a2 = a2.toLowerCase(), /\.(?:mjs|mts)$/iu.test(a2)) return Oe;
    if (/\.(?:cjs|cts)$/iu.test(a2)) return Nt;
  }
}
function jr(a2, t) {
...
function qr(a2, t) {
  ...
  let s = ms(a2, 0);
  return s !== !1 && (a2 = a2.slice(0, s)), zr.test(a2);
}
function $r(a2, t, e) {
...
function Kr({ isExpression: a2 = !1, optionsCombinations: t }) {
  return (e, s = {}) => {
    let { filepath: i } = s;
    ...
    n && n !== Oe && (r = r.map((u) => ({ ...u, sourceType: n, ...n === Nt ? { allowReturnOutsideFunction: void 0, allowNewTargetOutsideFunction: void 0 } : void 0 })));
    let o = /%[A-Z]/u.test(e);
...
function re(a2) {
  switch (a2.type) {
    case "ArrayExpression":
      for (let t of a2.elements) t !== null && re(t);
      return;
    case "ObjectExpression":
      for (let t of a2.properties) re(t);
      return;
    case "ObjectProperty":
      if (a2.computed) throw q(a2.key, "Computed key");
      if (a2.shorthand) throw q(a2.key, "Shorthand property");
      a2.key.type !== "Identifier" && re(a2.key), re(a2.value);
      return;
    case "UnaryExpression": {
      let { operator: t, argument: e } = a2;
      if (t !== "+" && t !== "-") throw q(a2, `Operator '${a2.operator}'`);
      if (e.type === "NumericLiteral" || e.type === "Identifier" && (e.name === "Infinity" || e.name === "NaN")) return;
      throw q(e, `Operator '${t}' before '${e.type}'`);
    }
    case "Identifier":
      if (a2.name !== "Infinity" && a2.name !== "NaN" && a2.name !== "undefined") throw q(a2, `Identifier '${a2.name}'`);
      return;
    case "TemplateLiteral":
      if (vt(a2.expressions)) throw q(a2.expressions[0], "'TemplateLiteral' with expression");
      for (let t of a2.quasis) re(t);
      return;
    case "NullLiteral":
    case "BooleanLiteral":
    case "NumericLiteral":
...
- Did you mean \`import { "${a2}" as foo }\`?`, ImportCallArity: "`import()` requires exactly one or two arguments.", ImportCallNotNewExpression: "Cannot use new with import(...).", ImportCallSpreadArgument: "`...` is not allowed in `import()`.", ImportJSONBindingNotDefault: "A JSON module can only be imported with `default`.", ImportReflectionHasAssertion: "`import module x` cannot have assertions.", ImportReflectionNotBinding: 'Only `import module x from "./module"` is valid.', IncompatibleRegExpUVFlags: "The 'u' and 'v' regular expression flags cannot be enabled at the same time.", InvalidBigIntLiteral: "Invalid BigIntLiteral.", InvalidCodePoint: "Code point out of bounds.", InvalidCoverDiscardElement: "'void' must be followed by an expression when not used in a binding position.", InvalidCoverInitializedName: "Invalid shorthand property initializer.", InvalidDecimal: "Invalid decimal.", InvalidDigit: ({ radix: a2 }) => `Expected number in radix ${a2}.`, InvalidEscapeSequence: "Bad character escape sequence.", InvalidEscapeSequenceTemplate: "Invalid escape sequence in template.", InvalidEscapedReservedWord: ({ reservedWord: a2 }) => `Escape sequence in keyword ${a2}.`, InvalidIdentifier: ({ identifierName: a2 }) => `Invalid identifier ${a2}.`, InvalidLhs: ({ ancestor: a2 }) => `Invalid left-hand side in ${be(a2)}.`, InvalidLhsBinding: ({ ancestor: a2 }) => `Binding invalid left-hand side in ${be(a2)}.`, InvalidLhsOptionalChaining: ({ ancestor: a2 }) => `Invalid optional chaining in the left-hand side of ${be(a2)}.`, InvalidNumber: "Invalid number.", InvalidOrMissingExponent: "Floating-point numbers require a valid exponent after the 'e'.", InvalidOrUnexpectedToken: ({ unexpected: a2 }) => `Unexpected character '${a2}'.`, InvalidParenthesizedAssignment: "Invalid parenthesized assignment pattern.", InvalidPrivateFieldResolution: ({ identifierName: a2 }) => `Private name #${a2} is not defined.`, InvalidPropertyBindingPattern: "Binding member expression.", InvalidRecordProperty: "Only properties and spread elements are allowed in record definitions.", InvalidRestAssignmentPattern: "Invalid rest operator's argument.", LabelRedeclaration: ({ labelName: a2 }) => `Label '${a2}' is already declared.`, LetInLexicalBinding: "'let' is disallowed as a lexically bound name.", LineTerminatorBeforeArrow: "No line break is allowed before '=>'.", MalformedRegExpFlags: "Invalid regular expression flag.", MissingClassName: "A class name is required.", MissingEqInAssignment: "Only '=' operator can be used for specifying default value.", MissingSemicolon: "Missing semicolon.", MissingPlugin: ({ missingPlugin: a2 }) => `This experimental syntax requires enabling the parser plugin: ${a2.map((t) => JSON.stringify(t)).join(", ")}.`, MissingOneOfPlugins: ({ missingPlugin: a2 }) => `This experimental syntax requires enabling one of the following parser plugin(s): ${a2.map((t) => JSON.stringify(t)).join(", ")}.`, MissingUnicodeEscape: "Expecting Unicode escape sequence \\uXXXX.", MixingCoalesceWithLogical: "Nullish coalescing operator(??) requires parens when mixing with logical operators.", ModuleAttributeDifferentFromType: "The only accepted module attribute is `type`.", ModuleAttributeInvalidValue: "Only string literals are allowed as module attribute values.", ModuleAttributesWithDuplicateKeys: ({ key: a2 }) => `Duplicate key "${a2}" is not allowed in module attributes.`, ModuleExportNameHasLoneSurrogate: ({ surrogateCharCode: a2 }) => `An export name cannot include a lone surrogate, found '\\u${a2.toString(16)}'.`, ModuleExportUndefined: ({ localName: a2 }) => `Export '${a2}' is not defined.`, MultipleDefaultsInSwitch: "Multiple default clauses.", NewlineAfterThrow: "Illegal newline after throw.", NoCatchOrFinally: "Missing catch or finally clause.", NumberIdentifier: "Identifier directly after number.", NumericSeparatorInEscapeSequence: "Numeric separators are not allowed inside unicode escape sequences or hex escape sequences.", ObsoleteAwaitStar: "'await*' has been removed from the async functions proposal. Use Promise.all() instead.", OptionalChainingNoNew: "Constructors in/after an Optional Chain are not allowed.", OptionalChainingNoTemplate: "Tagged Template Literals are not allowed in optionalChain.", OverrideOnConstructor: "'override' modifier cannot appear on a constructor declaration.", ParamDupe: "Argument name clash.", PatternHasAccessor: "Object pattern can't contain getter or setter.", PatternHasMethod: "Object pattern can't contain methods.", PrivateInExpectedIn: ({ identifierName: a2 }) => `Private names are only allowed in property accesses (\`obj.#${a2}\`) or in \`in\` expressions (\`#${a2} in obj\`).`, PrivateNameRedeclaration: ({ identifierName: a2 }) => `Duplicate private name #${a2}.`, RecordExpressionBarIncorrectEndSyntaxType: "Record expressions ending with '|}' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionBarIncorrectStartSyntaxType: "Record expressions starting with '{|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", RecordExpressionHashIncorrectStartSyntaxType: "Record expressions starting with '#{' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", RecordNoProto: "'__proto__' is not allowed in Record expressions.", RestTrailingComma: "Unexpected trailing comma after rest element.", SloppyFunction: "In non-strict mode code, functions can only be declared at top level or inside a block.", SloppyFunctionAnnexB: "In non-strict mode code, functions can only be declared at top level, inside a block, or as the body of an if statement.", SourcePhaseImportRequiresDefault: 'Only `import source x from "./module"` is valid.', StaticPrototype: "Classes may not have static property named prototype.", SuperNotAllowed: "`super()` is only valid inside a class constructor of a subclass. Maybe a typo in the method name ('constructor') or not extending another class?", SuperPrivateField: "Private fields can't be accessed on super.", TrailingDecorator: "Decorators must be attached to a class element.", TupleExpressionBarIncorrectEndSyntaxType: "Tuple expressions ending with '|]' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionBarIncorrectStartSyntaxType: "Tuple expressions starting with '[|' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'bar'.", TupleExpressionHashIncorrectStartSyntaxType: "Tuple expressions starting with '#[' are only allowed when the 'syntaxType' option of the 'recordAndTuple' plugin is set to 'hash'.", UnexpectedArgumentPlaceholder: "Unexpected argument placeholder.", UnexpectedAwaitAfterPipelineBody: 'Unexpected "await" after pipeline body; await must have parentheses in minimal proposal.', UnexpectedDigitAfterHash: "Unexpected digit after hash token.", UnexpectedImportExport: "'import' and 'export' may only appear at the top level.", UnexpectedKeyword: ({ keyword: a2 }) => `Unexpected keyword '${a2}'.`, UnexpectedLeadingDecorator: "Leading decorators must be attached to a class declaration.", UnexpectedLexicalDeclaration: "Lexical declaration cannot appear in a single-statement context.", UnexpectedNewTarget: "`new.target` can only be used in functions or class properties.", UnexpectedNumericSeparator: "A numeric separator is only allowed between two digits.", UnexpectedPrivateField: "Unexpected private name.", UnexpectedReservedWord: ({ reservedWord: a2 }) => `Unexpected reserved word '${a2}'.`, UnexpectedSuper: "'super' is only allowed in object methods and classes.", UnexpectedToken: ({ expected: a2, unexpected: t }) => `Unexpected token${t ? ` '${t}'.` : ""}${a2 ? `, expected "${a2}"` : ""}`, UnexpectedTokenUnaryExponentiation: "Illegal expression. Wrap left hand side or entire exponentiation in parentheses.", UnexpectedUsingDeclaration: "Using declaration cannot appear in the top level when source type is `script` or in the bare case statement.", UnexpectedVoidPattern: "Unexpected void binding.", UnsupportedBind: "Binding should be performed on object property.", UnsupportedDecoratorExport: "A decorated export must export a class declaration.", UnsupportedDefaultExport: "Only expressions, functions or classes are allowed as the `default` export.", UnsupportedImport: "`import` can only be used in `import()` or `import.meta`.", UnsupportedMetaProperty: ({ target: a2, onlyValidPropertyName: t }) => `The only valid meta property for ${a2} is ${a2}.${t}.`, UnsupportedParameterDecorator: "Decorators cannot be used to decorate parameters.", UnsupportedPropertyDecorator: "Decorators cannot be used to decorate object literal properties.", UnsupportedSuper: "'super' can only be used with function calls (i.e. super()) or in property accesses (i.e. super.prop or super[prop]).", UnterminatedComment: "Unterminated comment.", UnterminatedRegExp: "Unterminated regular expression.", UnterminatedString: "Unterminated string constant.", UnterminatedTemplate: "Unterminated template.", UsingDeclarationExport: "Using declaration cannot be exported.", UsingDeclarationHasBindingPattern: "Using declaration cannot have destructuring patterns.", VarRedeclaration: ({ identifierName: a2 }) => `Identifier '${a2}' has already been declared.`, VoidPatternCatchClauseParam: "A void binding can not be the catch clause parameter. Use `try { ... } catch { ... }` if you want to discard the caught error.", VoidPatternInitializer: "A void binding may not have an initializer.", YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", YieldNotInGeneratorFunction: "'yield' is only allowed within generator functions.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, Xs = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: ({ referenceName: a2 }) => `Assigning to '${a2}' in strict mode.`, StrictEvalArgumentsBinding: ({ bindingName: a2 }) => `Binding '${a2}' in strict mode.`, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, Ys = { ParseExpressionEmptyInput: "Unexpected parseExpression() input: The input is empty or contains only comments.", ParseExpressionExpectsEOF: ({ unexpected: a2 }) => `Unexpected parseExpression() input: The input should contain exactly one expression, but the first expression is followed by the unexpected character \`${String.fromCodePoint(a2)}\`.` }, Qs = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), Zs = Object.assign({ PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic references are only supported when using the `"proposal": "hack"` version of the pipeline proposal.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: ({ token: a2 }) => `Invalid topic token ${a2}. In order to use ${a2} as a topic reference, the pipelineOperator plugin must be configured with { "proposal": "hack", "topicToken": "${a2}" }.`, PipeTopicUnused: "Hack-style pipe body does not contain a topic reference; Hack-style pipes must use topic at least once.", PipeUnparenthesizedBody: ({ type: a2 }) => `Hack-style pipe body cannot be an unparenthesized ${be({ type: a2 })}; please wrap it in parentheses.` }, {}), ei = ["message"];
    ...
    Ei = /* @__PURE__ */ new Set(["break", "case", "catch", "continue", "debugger", "default", "do", "else", "finally", "for", "function", "if", "return", "switch", "throw", "try", "var", "const", "while", "with", "new", "this", "super", "class", "extends", "export", "import", "null", "true", "false", "in", "instanceof", "typeof", "void", "delete", "implements", "interface", "let", "package", "private", "protected", "public", "static", "yield", "eval", "arguments", "enum", "await"]);
    ue = class {
      flags = 0;
...
`), cooked: r === null ? null : r.slice(1, l) }, o.tail = h, this.next();
        ...
        if (e) {
          if (s) {
            ...
            if (this.checkDuplicateExports(r, o), !i && r.local) {
              let { local: h } = r;
              h.type !== "Identifier" ? this.raise(p.ExportBindingIsString, r, { localName: h.value, exportName: o }) : (this.checkReservedWord(h.name, h.loc.start, !0, !1), this.scope.checkLocalExport(h));
            }
          }
    ...
    ua = ar(oi);
    Wt = /* @__PURE__ */ new Map();
    da = ke(/\s/u), cs = ke(" 	"), ma = ke(",; 	"), ls = ke(/[^\n\r]/u);
    ps = or, us = (a2) => a2 === `
` || a2 === "\r" || a2 === "\u2028" || a2 === "\u2029";
    fs = hr;
    ds = cr;
    ms = lr;
    ve = pr, ee = (a2, t) => (e, s, ...i) => e | 1 && s == null ? void 0 : (t.call(s) ?? s[a2]).apply(s, i), ur = Array.prototype.findLast ?? function(a2) {
      for (let t = this.length - 1; t >= 0; t--) {
        let e = this[t];
        if (a2(e, t, this)) return e;
      }
    }, fr = ee("findLast", function() {
      if (Array.isArray(this)) return ur;
    }), xs = fr;
    mr = ee("at", function() {
      if (Array.isArray(this) || typeof this == "string") return dr;
    }), Ps = mr;
    te = yr, xr = te(["Block", "CommentBlock", "MultiLine"]), se = xr, Pr = te(["Line", "CommentLine", "SingleLine", "HashbangComment", "HTMLOpen", "HTMLClose", "Hashbang", "InterpreterDirective"]), gs = Pr, St = /* @__PURE__ */ new WeakMap();
    Ts = gr;
