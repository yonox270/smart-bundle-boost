...
var polyfillOverrides = /* @__PURE__ */ new Map();
var setPolyfillOverrides = /* @__PURE__ */ __name((overrides) => {
      ...
      const resolver = /* @__PURE__ */ __name(async (args) => {
        const result = {
          ...
          error: {
            ...
            path: args.path,
            sideEffects: false,
            pluginData: { importer: path__default.default.relative(root, args.importer).replace(/\\/g, "/") }
          },
          none: void 0
        };
